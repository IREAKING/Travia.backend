...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ResponseContact_Swagger"
                        }
                    }
                ],
                "responses": {
        ...
        "/recommendation/similar/{tour_id}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Số lượng tour (mặc định: 5)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
        ...
        "/recommendation/tours": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Số lượng tour (mặc định: 10)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Phương pháp gợi ý: preferences, destinations, history, ai (mặc định: preferences)",
                        "name": "method",
                        "in": "query"
                    }
                ],
        ...
        "/recommendation/track-view": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Thông tin xem tour",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
